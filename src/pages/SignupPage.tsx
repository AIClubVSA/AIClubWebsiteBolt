...
export default function SignupPage() {
  ...
  const { sendSignUpOtp, verifySignUpOtp, signInWithGoogle } = useAuth();
            ...
            <>
              ...
              <div className="relative my-5">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-[#0a0a0f] px-3 text-xs text-gray-500 uppercase tracking-wider">or sign up with email</span>
                </div>
              </div>
