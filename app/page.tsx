...
// Module-level constant so the object identity is stable (avoids WebGL re-init)
const HYPER_OPTIONS = {
...
function splitChars(el: HTMLElement): HTMLElement[] {
  ...
  words.forEach((word, wi) => {
    // Keep each word intact (no mid-word line breaks) while still
...
/* ── Spatial ambient background (drifting light + parallax grid) ── */
...
/* ── Custom cursor (lagging ring + dot, reacts to interactive els) ─ */
...
export default function Home() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Hero parallax out — intensified with blur + scale + tilt
      ...
      // Manifesto word-by-word lighting (scrubbed) + container scale/tilt
      ...
      // Horizontal scroll gallery (pinned) + 3D depth carousel
      ...
      const depth = () => {
        ...
        cards.forEach((c) => {
          ...
          const d = (r.left + r.width / 2 - mid) / mid; // -1..1
      ...
      // Cinematic band — clip-path wipe reveal + parallax
      ...
      // Character-split heading reveals (scrubbed) — overloaded
      ...
      // Spatial background — drift, scroll parallax, hue shift
      ...
      // Pillars — 3D rotateX entrance + sweeping reveal line
      gsap.from(".pillar", {
      ...
      // Scroll-velocity skew (unique momentum feel) + active-section tracking
  ...
  return (
    <div className="lp" style={{ position: "relative", background: "transparent" }}>
      ...
      <nav style={{
        ...
        <div style={{ maxWidth: 1320, margin: "0 auto", height: 72, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            <Link href="/login" className="lp-link lp-hide-mobile" style={{ fontSize: 14, color: "var(--text-muted)" }}>Log in</Link>
            <Link href="/login" className="lp-btn lp-btn-solid" style={{ padding: "9px 18px", fontSize: 13 }}>Join the club <ArrowRight size={14} /></Link>
          </div>
        </div>
      </nav>
      ...
      <section id="top" className="hero" style={{ position: "relative", height: "100vh", minHeight: 680, overflow: "hidden", display: "flex", alignItems: "center" }}>
        ...
        <div className="hero-content" style={{ position: "relative", zIndex: 2, width: "100%", maxWidth: 1320, margin: "0 auto", padding: "0 clamp(20px,4vw,56px)" }}>
          ...
          <div className="hero-cta" style={{ display: "flex", gap: 14, marginTop: 40, flexWrap: "wrap" }}>
            <Link href="/login" className="lp-btn lp-btn-solid">Join the club <ArrowUpRight size={16} /></Link>
      ...
      {/* INTERACTIVE SPHERE — InfiniteMenu (React Bits) */}
      ...
      {/* FLOWING MENU — navigation (React Bits) */}
      ...
      <section id="join" style={{ padding: "clamp(120px,18vh,220px) clamp(20px,4vw,56px)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", textAlign: "center", position: "relative" }} data-fade>
          ...
          <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/login" className="lp-btn lp-btn-solid" style={{ padding: "15px 30px", fontSize: 15 }}>Enter the portal <ArrowUpRight size={17} /></Link>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 40, marginBottom: 56 }}>
            ...
            <div style={{ display: "flex", gap: "clamp(40px,8vw,100px)", flexWrap: "wrap" }}>
              ...
              <div>
                ...
                <Link href="/login" className="lp-link" style={{ display: "block", color: "var(--text-muted)", fontSize: 14, padding: "6px 0" }}>Member log in</Link>
                <Link href="/login" className="lp-link" style={{ display: "block", color: "var(--text-muted)", fontSize: 14, padding: "6px 0" }}>Join the club</Link>
              </div>
            </div>
          </div>
          <div className="lp-rule" />
